  ...
  <div class="flex min-h-[calc(100vh-80px)]">
    ...
    <main class="flex-1 p-6 overflow-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="stat-card text-center"><div class="text-2xl font-bold text-green-main">8888</div><div class="text-xs text-gray-500 mt-1">Commandes en attente</div></div>
      </div>
      <div class="card p-5">
