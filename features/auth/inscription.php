...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare('INSERT INTO utilisateur (email, nom, mot_de_passe, adresse, telephone, region_id, role) VALUES (?, ?, ?, ?, ?, ?, ?)');
        $stmt->execute([$email, $nom, $mot_de_passe, $adresse, $telephone, $region_id, $role]);
    } catch (Throwable $th) {
